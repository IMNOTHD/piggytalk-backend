...
func NewSnowflakeUsecase(logger log.Logger) *SnowflakeUsecase {
	return &SnowflakeUsecase{
		log: log.NewHelper(log.With(logger, "module", "snowflake/biz/snowflake/v1", "caller", log.DefaultCaller))}
}

func (su *SnowflakeUsecase) NewSnowflake(dataCenterId, workerId int64) (*Snowflake, error) {
