...
func (c *accountClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginReply, error) {
	out := new(LoginReply)
	err := c.cc.Invoke(ctx, "/gateway.api.account.v1.Account/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterReply, error) {
	...
	err := c.cc.Invoke(ctx, "/gateway.api.account.v1.Account/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountClient) UpdateAvatar(ctx context.Context, in *UpdateAvatarRequest, opts ...grpc.CallOption) (*UpdateAvatarReply, error) {
	...
	err := c.cc.Invoke(ctx, "/gateway.api.account.v1.Account/UpdateAvatar", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Account_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gateway.api.account.v1.Account/Login",
	}
...
func _Account_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gateway.api.account.v1.Account/Register",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Account_UpdateAvatar_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gateway.api.account.v1.Account/UpdateAvatar",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Account_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gateway.api.account.v1.Account",
